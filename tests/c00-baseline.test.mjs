...
test('C00 quick run records measured scenarios, observations, quality, and target gaps', async () => {
  ...
  try {
    ...
    assert.equal(artifact.characterization.evidence['E-01'].reproduced, false)
    assert.equal(artifact.characterization.evidence['E-02'].reproduced, false)
    ...
    assert.equal(artifact.characterization.evidence['E-06'].reproduced, false)
    assert.equal(artifact.characterization.evidence['E-07'].reproduced, false)
